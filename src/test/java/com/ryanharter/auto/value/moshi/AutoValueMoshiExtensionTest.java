...
public class AutoValueMoshiExtensionTest {
  ...
  @Test public void simple() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
            ...
            + "      this.aAdapter = adapter(moshi, String.class, \"a\");\n"
            + "      this.bAdapter = adapter(moshi, int[].class, \"b\");\n"
            + "      this.cAdapter = adapter(moshi, Integer.class, \"c\");\n"
            + "      this.dAdapter = adapter(moshi, String.class, \"d\");\n"
            + "      this.eAdapter = adapter(moshi, Types.newParameterizedType(Map.class, String.class, Number.class), \"e\");\n"
            + "      this.fAdapter = adapter(moshi, Types.newParameterizedType(Set.class, String.class), \"f\");\n"
            + "      this.gAdapter = adapter(moshi, Types.newParameterizedType(Map.class, String.class, Types.newParameterizedType(Set.class, String.class)), \"g\");\n"
            + "      this.iAdapter = adapter(moshi, String.class, \"i\");\n"
            + "    }\n"
            + "  \n"
            ...
            + "      writer.endObject();\n"
            + "    }\n"
            + "    private JsonAdapter adapter(Moshi moshi, Type type, String methodName) {\n"
            + "      try {\n"
            + "          Method method = Test.class.getDeclaredMethod(methodName);\n"
            ...
            + "              }\n"
            + "          }\n"
            + "          return moshi.adapter(type, annotations);\n"
  ...
  @Test public void propertyMethodReferencedWithPrefix() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "    public AutoValue_TestJsonAdapter(Moshi moshi) {\n"
        + "      this.nameAdapter = adapter(moshi, String.class, \"getName\");\n"
        + "      this.awesomeAdapter = adapter(moshi, Boolean.class, \"isAwesome\");\n"
        + "    }\n"
        + "    @Override\n"
  ...
  @Test public void usesJsonQualifierAnnotations() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Foo", ""
        ...
        + "      this.aAdapter = adapter(moshi, String.class, \"a\");\n"
        + "      this.bAdapter = adapter(moshi, String.class, \"b\");\n"
        + "    }\n"
        + "    @Override\n"
