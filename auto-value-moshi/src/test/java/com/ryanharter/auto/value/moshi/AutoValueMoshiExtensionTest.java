...
public final class AutoValueMoshiExtensionTest {
  ...
  @Test public void allNullable() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "      if (a != null) {\n"
        + "        writer.name(\"a\");\n"
        + "        aAdapter.toJson(writer, a);\n"
        + "      }\n"
        + "      int[] b = value.b();"
        + "      if (b != null) {\n"
        + "        writer.name(\"b\");\n"
        + "        bAdapter.toJson(writer, b);\n"
        + "      }\n"
        + "      Integer c = value.c();"
        + "      if (c != null) {\n"
        + "        writer.name(\"c\");\n"
        + "        cAdapter.toJson(writer, c);\n"
        + "      }\n"
        + "      List<String> d = value.d();"
        + "      if (d != null) {\n"
        + "        writer.name(\"d\");\n"
        + "        dAdapter.toJson(writer, d);\n"
        + "      }\n"
        + "      Map<String, Number> e = value.e();"
        + "      if (e != null) {\n"
        + "        writer.name(\"e\");\n"
        + "        eAdapter.toJson(writer, e);\n"
        + "      }\n"
        + "      Set<? extends String> f = value.f();"
        + "      if (f != null) {\n"
        + "        writer.name(\"f\");\n"
        + "        fAdapter.toJson(writer, f);\n"
        + "      }\n"
        + "      Map<String, Set<? super String>> g = value.g();"
        + "      if (g != null) {\n"
        + "        writer.name(\"g\");\n"
        + "        gAdapter.toJson(writer, g);\n"
        + "      }\n"
        + "      writer.endObject();\n"
        + "    }\n"
        + "  }\n"
