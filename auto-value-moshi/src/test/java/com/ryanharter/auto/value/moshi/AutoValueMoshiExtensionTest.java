...
public final class AutoValueMoshiExtensionTest {
  ...
  @Test public void allNullable() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "\n"
        + "final class AutoValue_Test extends $AutoValue_Test {\n"
        + "  AutoValue_Test(String a, int[] b, Integer c, List<String> d, Map<String, Number> e, "
        ...
        + "      this.dAdapter = moshi.adapter(Types.newParameterizedType(List.class, "
        + "         String.class));\n"
        + "      this.eAdapter = moshi.adapter(Types.newParameterizedType(Map.class, String.class, "
        + "         Number.class));\n"
        + "      this.fAdapter = moshi.adapter(Types.newParameterizedType(Set.class, "
  ...
  @Test public void nullableWillValueAndWriterAsProperties() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "\n"
        + "final class AutoValue_Test extends $AutoValue_Test {\n"
        + "  AutoValue_Test(String value, String writer) {\n"
        + "    super(value, writer);\n"
        + "  }\n"
        + "\n"
        + "  public static final class MoshiJsonAdapter extends JsonAdapter<Test> {\n"
        ...
        + "      this.writerAdapter = moshi.adapter(String.class);\n"
        + "    }\n"
        + "  \n"
        + "    @Override public Test fromJson(JsonReader reader) throws IOException {\n"
        + "      reader.beginObject();\n"
  ...
  @Test public void propertyContainsAdapterAsName() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Test", ""
        ...
        + "\n"
        + "final class AutoValue_Test extends $AutoValue_Test {\n"
        + "  AutoValue_Test(String a, String aAdapter) {\n"
        + "    super(a, aAdapter);\n"
        + "  }\n"
        + "\n"
        + "  public static final class MoshiJsonAdapter extends JsonAdapter<Test> {\n"
        ...
        + "    public AutoValue_TestJsonAdapter(Moshi moshi) {\n"
        + "      this.aAdapter = moshi.adapter(String.class);\n"
        + "      this.aAdapterAdapter = moshi.adapter(String.class);\n"
        + "    }\n"
        + "  \n"
        + "    @Override public Test fromJson(JsonReader reader) throws IOException {\n"
        + "      reader.beginObject();\n"
  ...
  @Test public void usesJsonQualifierAnnotations() {
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Foo", ""
        ...
        + "      this.aAdapter = moshi.adapter(String.class);\n"
        + "      this.bAdapter = adapter(moshi, \"b\", null);\n"
        + "    }\n"
        + "    @Override\n"
  ...
  @Test public void genericsAndQualifiers() {
    ...
    JavaFileObject source = JavaFileObjects.forSourceString("test.Foo", ""
       ...
       + "  public static <T>JsonAdapter<Foo<T>> jsonAdapter(Moshi moshi, "
       + "      Type[] types) {\n"
       + "    return null;"
       + "  }\n"
    ...
    JavaFileObject expected = JavaFileObjects.forSourceString("test/AutoValue_Foo", ""
        ...
        + "import java.util.List;\n"
        + "import java.util.Set;\n"
        + "final class AutoValue_Foo<T> extends $AutoValue_Foo<T> {\n"
        + "  AutoValue_Foo(T genericItem, List<T> listWithQualifier, String normalProperty) {\n"
        + "    super(genericItem, listWithQualifier, normalProperty);\n"
        + "  }          \n"
        + "  public static final class MoshiJsonAdapter<T> extends JsonAdapter<Foo<T>> {\n"
        + "    private static final String[] NAMES = new String[]\n"
        + "        {\"genericItem\",\"listWithQualifier\",\"normalProperty\"};\n"
        + "    private static final JsonReader.Options OPTIONS = JsonReader.Options.of(NAMES);\n"
        ...
        + "    public MoshiJsonAdapter(Moshi moshi, Type[] types) {\n"
        + "      this.genericItemAdapter = adapter(moshi, \"genericItem\", types[0]);\n"
        + "      this.listWithQualifierAdapter = moshi.adapter(\n"
        + "          Types.newParameterizedType(List.class, types[0]));\n"
        + "      this.normalPropertyAdapter = moshi.adapter(String.class);\n"
        + "    }        \n"
        + "    @Override\n"
        + "    public Foo<T> fromJson(JsonReader reader) throws IOException {\n"
        + "      reader.beginObject();\n"
        + "      T genericItem = null;\n"
        ...
        + "      }\n"
        + "      reader.endObject();\n"
        + "      return new AutoValue_Foo(genericItem, listWithQualifier, normalProperty);\n"
        + "    }\n"
        + "    @Override\n"
        + "    public void toJson(JsonWriter writer, Foo<T> value) throws IOException {\n"
        + "      writer.beginObject();\n"
